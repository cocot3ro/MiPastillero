package com.example.old.old.old_viewModel

import android.content.Context
import android.content.Intent
import android.net.Uri
import androidx.lifecycle.ViewModel
import com.example.old.old.old_model.ContratoActivos
import com.example.old.old.old_model.ContratoHistorial
import com.example.old.old.old_model.DBHelper
import com.example.old.old.old_model.Medicamento
import com.example.old.old.old_notification.NotificationsService
    ...
    suspend fun searchMedicamento(codNacional: String): Medicamento.Builder? {
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                GsonBuilder()
                    .registerTypeAdapter(
                        Medicamento.Builder::class.java,
                        com.example.old.old.old_model.APITypeAdapter()
                    )
                    .create()
