package com.example.old.old.old_model
...
@Deprecated("old")
class APITypeAdapter : TypeAdapter<com.example.old.old.old_model.Medicamento.Builder>() {

    override fun write(writer: JsonWriter, value: com.example.old.old.old_model.Medicamento.Builder) {}

    override fun read(reader: JsonReader): com.example.old.old.old_model.Medicamento.Builder {
        val builder = com.example.old.old.old_model.Medicamento.Builder()
