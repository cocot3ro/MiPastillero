...
import com.example.old.old.old_viewModel.PillboxViewModel
import com.example.old.R
import com.example.old.databinding.OldEmptyLayoutBinding
import com.example.old.databinding.OldFavoriteCardLayoutBinding
import com.example.old.databinding.OldFragmentFavoriteBinding
import com.example.old.old.old_utils.DateTimeUtils
    ...
    private fun addCardView(medicamento: Medicamento) {
        ...
        cardViewBinding.cuerpo.setBackgroundColor(
            ContextCompat.getColor(
                requireContext(),
                DateTimeUtils.getEstacionColor().second
            )
        )
